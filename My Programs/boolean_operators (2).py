...
def main():
    ...
    if (t > 20) and (h >= 40):
        sense.show_message("It is hot and humid",0.08,[255,0,0],
                           [255,255,0])
        answer = input("Do you want to see the " + \
                       "temperature and humidity? ").lower()
        if answer == "y":
    ...
    if t > 20:
        if h >= 40:
            ...
            sense.show_message("It is hot and dry",0.08,[255,0,0],
                     [0,0,0])
    else: # t <= 20
        if h >= 40:
            sense.show_message("It is cool and humid",0.08,[0,0,255],
                    [0,255,0])
        else:
            sense.show_message("It is cool and dry",0.08,[0,0,255],
                    [0,0,0])
    sense.clear()
main()
