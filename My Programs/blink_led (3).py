    ...
    try:
        while True:
            if GPIO.input(pir_pin) == 1:
                ...
                if email_sent != True:
                    send_email("oneup4klm@gmail.com",\ "oneup4klm@gmail.com", \ "oneup4klm@gmail.com","secret", \ "Raspberry Pi Intruder Detected!")
                    #Google Search: "gmail allow less secure apps"
                    email_sent = True
